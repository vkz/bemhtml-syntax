...
syntax.generate = function generate(newAst, ugly) {
  lazyLoad();
  var result = BEMHTMLToJS.match(newAst, 'topLevel');
  // TODO switch to UglifyJS which handles Unicode correctly!!!
  // TODO custom indentation in js-bemhtml style
  return ugly?
    result:
